...
void setup() {
  ...
  if ( imageLandscape==true ) {
    ...
    //centering the image, use imageDivXchanged,ImagedivYchanged
    imageDivXchanged = imageDivX;
    imageDivX  = imageDivXchanged;
    float leftOverHeight=(imageDivHeight - imageDivHeightchange) *1/2;
    ImagedivYchanged =imageDivY+leftOverHeight;
   }
  }
  //
  //DIV
 rect(imageDivX,imageDivY,imageDivWidth,imageDivHeight );
  //
  //Prototype Images
  image( myFirstImage, imageDivXchanged, imageDivYchanged, imageWidthChanged, imageHeightChanged );
  //
} //End setup
//
void draw() {
